...
2.下载[client.json](https://raw.githubusercontent.com/TinrLin/Tuic-build-tutorial/main/tuic.service)文件→里面的信息修改为你自己的→打开V2rayN→服务器→添加自定义服务器→导入修改好的client.json文件
